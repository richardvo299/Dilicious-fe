...
function AboutUsPage() {
    return (
        <div className="aboutus-info" style={{marginBottom: "32px"}}>
            <Helmet>
                <meta charSet='utf-8' />
            ...
            <Row>
                ...
                <Col sm={12} md={6}>
                    ...
                    <br></br>
                    <br></br>
                    With the motto of "Everybody deserves a good cake", Dilicious provides customizable baked goods options. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
                    <br></br>
                    <br></br>
